...
export default function Payment() {
  ...
  const getDataFromStorage = () => {
    setParamData(JSON.parse(localStorage.getItem("paymentData")));
  };
  useEffect(() => {
    grandTotalPrice();
    getDataFromStorage();
  ...
  return (
    <div>
      <Header />
      {paramData === null || paramData === "" ? (
        <h1 className='text-center'> Pembayaran Belum ada</h1>
      ) : (
        <Content props='bg-silverWhite'>
          <div className='sm:flex sm:justify-center lg:justify-evenly sm:-mx-4 sm:flex-wrap md:py-4'>
            ...
            <div className='m-10 bg-white border-2 lg:w-1/3'>
              ...
              <div className='flex flex-row my-2 justify-between'>
                <h2 className='text-lg mx-10'>Address</h2>
